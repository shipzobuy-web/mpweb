        ...
        <BaseLayout pageTitle={guild.name} navGuild={guild}>
          <Flex p={5} justifyContent="center" gap={10} wrap="wrap">
            <ModuleBox
              module="Moderation"
              icon={FaHammer}
              modStatus={"Moderation" in moduleSettings ? moduleSettings.Moderation.enabled : true}
            />
            <ModuleBox
              module="Rules"
              icon={FaCheck}
              modStatus={"Rules" in moduleSettings ? moduleSettings.Rules.enabled : true}
            />
            <ModuleBox
              module="Backups"
              icon={FaDatabase}
              modStatus={"Backups" in moduleSettings ? moduleSettings.Backups.enabled : true}
            />
            <ModuleBox
              moduleName="Anti Raid"
              module="AntiRaid"
              icon={FaHandPaper}
              modStatus={"AntiRaid" in moduleSettings ? moduleSettings.AntiRaid.enabled : true}
            />
            <ModuleBox
              moduleName="Anti Phishing"
              module="AntiPhishing"
              icon={FaFish}
              modStatus={"AntiPhishing" in moduleSettings ? moduleSettings.AntiPhishing.enabled : true}
            />
            <ModuleBox
              moduleName="Webhook Protection"
              module="Webhooks"
              icon={FaChessRook}
              modStatus={"Webhooks" in moduleSettings ? moduleSettings.Webhooks.enabled : true}
            />
            <ModuleBox
              moduleName="Special Channels"
              module="ContentProtect"
              icon={FaMailBulk}
              modStatus={"ContentProtect" in moduleSettings ? moduleSettings.ContentProtect.enabled : true}
            />
          </Flex>
        </BaseLayout>
      )}
