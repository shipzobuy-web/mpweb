    ...
    return (
        ...
        >
            <Flex direction="column" justifyContent="center" alignItems="center" className="animate">
                <Text className="animate" fontSize="2.5vw" textAlign="center">
                    {data}
                </Text>
                <Text className="animate" fontSize="1vw" textAlign="center" wordBreak="break-all">
                    {label}
                </Text>
            </Flex>
