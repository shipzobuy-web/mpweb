        ...
        <BaseLayout pageTitle={guild.name} navGuild={guild}>
          <Flex p={5} justifyContent="center" gap={10} wrap="wrap">
            <ModuleBox
              ...
              icon={FaHammer}
              modStatus={
                "Moderation" in moduleSettings
                  ? moduleSettings.Moderation.enabled
                  : true
              }
            />
            <ModuleBox
              ...
              icon={FaCheck}
              modStatus={
                "Rules" in moduleSettings
                  ? moduleSettings.Rules.enabled
                  : true
              }
            />
            <ModuleBox
              ...
              icon={FaDatabase}
              modStatus={
                "Backups" in moduleSettings
                  ? moduleSettings.Backups.enabled
                  : true
              }
            />
            <ModuleBox
              ...
              icon={FaHandPaper}
              modStatus={
                "AntiRaid" in moduleSettings
                  ? moduleSettings.AntiRaid.enabled
                  : true
              }
            />
            <ModuleBox
              ...
              icon={FaFish}
              modStatus={
                "AntiPhishing" in moduleSettings
                  ? moduleSettings.AntiPhishing.enabled
                  : true
              }
            />
            <ModuleBox
              ...
              icon={FaChessRook}
              modStatus={
                "Webhooks" in moduleSettings
                  ? moduleSettings.Webhooks.enabled
                  : true
              }
            />
            <ModuleBox
              ...
              icon={FaMailBulk}
              modStatus={
                "ContentProtect" in moduleSettings
                  ? moduleSettings.ContentProtect.enabled
                  : true
              }
            />
          </Flex>
...
export const getServerSideProps = async (ctx) => {
  ...
  // Fetch bot guilds from your DB
  const botGuilds = await FetchBotGuilds();
  let guild = botGuilds.find((g) => g._id === guildId) || null;

  // If bot is not in guild, guild stays null, and "Invite Bot" button appears
  if (guild) {
    guild = {
      ...guild,
  ...
  const module = guild ? new Modules(guild._id) : null;
  const moduleSettings = module ? await module.get() : {};
